...
REGISTRY_STACK_MIRROR_REGISTRY_SRV_NAME='local_registry_stack_mirror_docker_registry'
REGISTRY_STACK_PRIVATE_REGISTRY_SRV_NAME='local_registry_stack_docker_registry'
...
REVERSE_PROXY_IMAGE_REFERENCE='${LOCAL_REGISTRY_HOST_a8a1ce1e}/nginx'
