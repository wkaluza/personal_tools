...
function install_tekton_cli
{
  ...
  local url="https://github.com/tektoncd/cli/releases/download"
  local version="0.28.0"
  local executable_name="tkn"
  ...
  wget \
    -q \
    -O "${archive_path}" \
    "${url}/v${version}/${executable_name}_${version}_Linux_x86_64.tar.gz"
...
function install_kyverno_cli
{
  ...
  wget \
    -q \
    -O "${archive_path}" \
    "${url}/v${version}/${executable_name}-cli_v${version}_linux_x86_64.tar.gz"
